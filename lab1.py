...
#year == int.simpledialog.askinteger("Input", "Greetings! What is your year of origin?", parent=tk.Tk().withdraw())
...
#			print(self.name + "hasing its" + str(currentBirthday) + "birthday!")
#			currentBirthday += 1 
